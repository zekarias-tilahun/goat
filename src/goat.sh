...
python ./src/main.py --input ./data/cora/graph.txt --output-dir ./data/cora/outputs/ --tr-rate .15 --dropout 0.5 --epochs 10
...
#--emb-path ./data/cora/outputs/gap_context_15.emb --context True